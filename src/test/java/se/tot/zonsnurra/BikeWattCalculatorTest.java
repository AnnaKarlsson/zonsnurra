...
public class BikeWattCalculatorTest {
  ...
  public void test() {
    ...
    assert_zone_is_between(2, Watt.of(131), Watt.of(176));
    assert_zone_is_between(3, Watt.of(178), Watt.of(211));
    assert_zone_is_between(4, Watt.of(214), Watt.of(247));
    assert_zone_is_between(5, Watt.of(249), Watt.of(285));
    assert_zone_is_between(6, Watt.of(285), Watt.of(475));
  }
